...
00000000 <thread1>:
      ...
      14:	eb000259 	bl	980 <semDown>
      18:	e59f1024 	ldr	r1, [pc, #36]	@ 44 <thread1+0x44>
      1c:	e3a00001 	mov	r0, #1
      20:	eb000447 	bl	1144 <printf>
      24:	e59f001c 	ldr	r0, [pc, #28]	@ 48 <thread1+0x48>
      28:	eb00027c 	bl	a20 <semUp>
      2c:	eb000397 	bl	e90 <thread_exit>
      30:	e3a03000 	mov	r3, #0
      34:	e1a00003 	mov	r0, r3
      38:	e24bd004 	sub	sp, fp, #4
      3c:	e8bd8800 	pop	{fp, pc}
      40:	00001998 	.word	0x00001998
      44:	00001800 	.word	0x00001800
      48:	000019b0 	.word	0x000019b0
...
0000004c <thread2>:
      ...
      60:	eb000246 	bl	980 <semDown>
      64:	e59f1024 	ldr	r1, [pc, #36]	@ 90 <thread2+0x44>
      68:	e3a00001 	mov	r0, #1
      6c:	eb000434 	bl	1144 <printf>
      70:	e59f001c 	ldr	r0, [pc, #28]	@ 94 <thread2+0x48>
      74:	eb000269 	bl	a20 <semUp>
      78:	eb000384 	bl	e90 <thread_exit>
      7c:	e3a03000 	mov	r3, #0
      80:	e1a00003 	mov	r0, r3
      84:	e24bd004 	sub	sp, fp, #4
      88:	e8bd8800 	pop	{fp, pc}
      8c:	00001998 	.word	0x00001998
      90:	00001810 	.word	0x00001810
      94:	000019b0 	.word	0x000019b0
...
0000080c <condWait>:
     ...
     888:	0000190c 	.word	0x0000190c
     88c:	00001930 	.word	0x00001930
...
00001580 <malloc>:
    ...
    16e0:	000019d0 	.word	0x000019d0
    16e4:	000019c8 	.word	0x000019c8
