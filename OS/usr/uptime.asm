...
00000000 <main>:
      ...
      20:	e59f1040 	ldr	r1, [pc, #64]	@ 68 <main+0x68>
      24:	e3a00002 	mov	r0, #2
      28:	eb0003f4 	bl	1000 <printf>
      2c:	eb000253 	bl	980 <exit>
      30:	eb0002fd 	bl	c2c <uptime>
      34:	e50b0008 	str	r0, [fp, #-8]
      38:	e51b3008 	ldr	r3, [fp, #-8]
      3c:	e59f2028 	ldr	r2, [pc, #40]	@ 6c <main+0x6c>
      40:	e0c21392 	smull	r1, r2, r2, r3
      44:	e1a02142 	asr	r2, r2, #2
      48:	e1a03fc3 	asr	r3, r3, #31
      4c:	e0423003 	sub	r3, r2, r3
      50:	e1a02003 	mov	r2, r3
      54:	e59f1014 	ldr	r1, [pc, #20]	@ 70 <main+0x70>
      58:	e3a00001 	mov	r0, #1
      5c:	eb0003e7 	bl	1000 <printf>
      60:	eb00031e 	bl	ce0 <printPages>
      64:	eb000245 	bl	980 <exit>
      68:	000016bc 	.word	0x000016bc
      6c:	66666667 	.word	0x66666667
...
000006c8 <condWait>:
     ...
     744:	00001770 	.word	0x00001770
     748:	00001794 	.word	0x00001794
...
0000143c <malloc>:
    ...
    159c:	000017fc 	.word	0x000017fc
    15a0:	000017f4 	.word	0x000017f4
